...
mysql_select_db($db['dbname'], $conna);
 ...
 $dem=1;
?>
<form action="default.php?url=xulyEdit.php" method="post">
<div width="600px" style="border-style:dashed; border-width:1px">
		<div id="" class="Divpannel" style="width:100%;">
			<p align="center">
				...
				while($data>0)	{
				?>
				<input type="radio" name="selectdethi" value="<?php echo "$dem"; ?>" /> <?php echo "Đề $dem";?></br>
				<?php
				$data--;
				$dem++;
				}
				?>
				<input type="submit" id="submit" name="chondeEdit" value="Bắt đầu thi" />
			</p>
		</div>
</div>
