...
mysql_select_db($db['dbname'], $conna);
  ...
  $sqls="SELECT * FROM diemthi where MaDe!=0";
					...
					<tr>
						<td>
							...
							<p style="text-align:center">
								<span id="ctl00_ContentPlaceHolder1_ctl00_ctl00_ctl00_lblTieude" style="font-size:30pt;">Thông kê</span>
							</p>
							...
							<table cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
									<td align="Center">
										<span id="ctl00_ContentPlaceHolder1_ctl00_ctl00_ctl00_lblHocphandangky" class="StudentInfoDetails_dl" style="font-size:14px;">Điểm kiểm tra của sinh viên</span>&nbsp;&nbsp;&nbsp;&nbsp;
									</td>
								</tr>
								<tr>
									<td>
											...
											<div>
												<table cellspacing="0" cellpadding="4" border="1" border="0" id="" style="color:#333333;width:100%;border-collapse:collapse;">
													...
													<tr style="background-color:#EFF3FB;font-size:10pt;">
														...
														</td><td align="center"><?php echo "$row[DisplayName]";?></td>
